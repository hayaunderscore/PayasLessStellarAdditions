...
function Game.update_new_round(self, dt)
	...
	if not G.STATE_COMPLETE and G.GAME.blind.config.blind.key == 'bl_plsa_prelude' then
		local valueToPutInIf = G.GAME.chips < G.GAME.blind.chips
		...
		G.GAME.blind:set_blind(G.P_BLINDS[G.GAME.plsa_prelude_next_blind])
